...
TEXTURE2D(_MLS_BakeryVolume0_From);
TEXTURE2D(_MLS_BakeryVolume0_To);
TEXTURE2D(_MLS_BakeryVolume1_From);
TEXTURE2D(_MLS_BakeryVolume1_To);
TEXTURE2D(_MLS_BakeryVolume2_From);
TEXTURE2D(_MLS_BakeryVolume2_To);
TEXTURE2D(_MLS_BakeryVolumeMask_From);
TEXTURE2D(_MLS_BakeryVolumeMask_To);
TEXTURE2D(_MLS_BakeryVolumeCompressed_From);
TEXTURE2D(_MLS_BakeryVolumeCompressed_To);
